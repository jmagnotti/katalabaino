...
public class MeanSampleCompletionResponseTimeMap extends Mapper {
	...
	public void nextTrial(Trial trial) {
		...
		// because some sample responses are emitted after the FR is completed
		// (i.e., the RT timer
		// is reset) the last Peck may not be the peck that completed the FR.
		// More importantly, the
		// last peck may be recorded as ``faster'' than the ones prior to it

		// to complicate matters further, we can't be sure of any ordering, so
		// we have to do an
		// exhaustive search :(
