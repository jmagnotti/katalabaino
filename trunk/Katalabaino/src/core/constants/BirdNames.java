...
public class BirdNames {
	...
	public static String[] MAGPIES = { "redx01", "red004", "red", "yellow", "yellowvc", "blueA3", "blueA0", "blueA", "blue" };
	public static String[] JAYS = { "caesar", "gonzo", "hans", "henry", "kermit", "marvin", "oscar", "snug", "soren", "theseus" };
